...
public class PetController {
    ...
    public ModelAndView index(){
        ...
        return new ModelAndView("pet/index","listaPets",listaPets); //o que isso faz é pegar o html e jogar os dados la dentro, dados da onde? do service
    }

    @GetMapping("/novo") //rota nova para o /novo
    public ModelAndView novo(){
        var pet = new Pet();// Cliente() ->        cliente
        return new ModelAndView("pet/form", "pet", pet); //aqui man do o cliente de cima para o form
    }
    ...
    public ModelAndView alterar(@PathVariable("id") long id){
        ...
        return new ModelAndView("pet/form", "pet", pet); //aqui eu mando o cliente para o form
    }
