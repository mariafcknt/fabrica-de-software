(function(){
    ...
    $("#tabpets").on("click", ".js-delete", function(){
        ...
        let botaoClicado = $(this); //Pegar a referencia de qua lbotao vermelho foi clicado
        $("#btnsim").attr("data-id", botaoClicado.attr("data-id")); //Pegar o id do botao clicado e passar para o botao sim
        $("#modalpet").modal("show"); //aparecer a modal na cara do usuário
    })
    ...
    $("#btnsim").on("click", function(){
        ...
        let id = botaoSim.attr("data-id");
        $.ajax({
            url: "/pets/delete/" + id,//para onde vamos chamar, qual endpoint
             method: "GET", //qual metodo vamos usar
            success: function(){
    ...
    $("#btnsim").on("click", function(){
        ...
        let id = botaoSim.attr("data-id");
        $.ajax({
            url: "/ordens/delete/" + id,//para onde vamos chamar, qual endpoint
             method: "GET", //qual metodo vamos usar
            success: function(){
